...
def main():
    ...
    weekly_job = Job(update_balance, datetime.timedelta(seconds=604800), first=datetime.time(hour=8))
    updater.job_queue.run_repeating(weekly_job, interval=datetime.timedelta(seconds=604800), first=datetime.time(hour=8))
